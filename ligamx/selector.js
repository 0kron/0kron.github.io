...
let refs_id = {
  18: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/17/17.png",
  16: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/1/1.png",
  3: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/12566/12566.png",
  10: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/16/16.png",
  1: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/29/29.png",
  11: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/9/9.png",
  9: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/14/14.png",
  7: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/11/11.png",
  15: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/11790/11790.png",
  5: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/18/18.png",
  2: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/7/7.png",
  14: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/12037/12037.png",
  4: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/5/5.png",
  13: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/10445/10445.png",
  6: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/11220/11220.png",
  8: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/12043/12043.png",
  17: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/11550/11550.png",
  12: "https://s3.amazonaws.com/lmxwebsite/docs/archdgtl/AfldDrct/logos/15/15.png"
}; 
...
document.getElementById("analizar").onclick = function(){
  ...
  if (id_equipo1 == id_equipo2){
    ...
    if (performance1 > performance2){
      ...
      razon_perf = String(Number((Math.abs(performance2/performance1) * 100)).toFixed(2));
    }
    else{
      id_ganador = id_equipo2; 
      id_perdedor =id_equipo1; 
      razon_perf = Number((Math.abs(performance1/performance2) * 100)).toFixed(2);
    }
